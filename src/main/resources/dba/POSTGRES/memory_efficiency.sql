...
--   , DI.DAG_ID
  ...
  , CONCAT(TO_CHAR((HQ.VIRTUAL_MEMORY/(1024*1024*1024)::FLOAT)::FLOAT, 'fm999G999G999G999G999G999G999D99'), 'GB')      VIRTUAL_MEMORY
  , CONCAT(TO_CHAR((HQ.PHYSICAL_MEMORY/(1024*1024*1024)::FLOAT)::FLOAT, 'fm999G999G999G999G999G999G999D99'), 'GB')      PHYSICAL_MEMORY
  , ROUND(HQ.VIRTUAL_MEMORY / HQ.PHYSICAL_MEMORY::NUMERIC, 3) MEM_EFFICIENCY
FROM
    HIVE_QUERY HQ
